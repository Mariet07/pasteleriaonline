document.addEventListener('DOMContentLoaded', () => {
    // Variables
    let baseDeDatos = [
        { id: 1, nombre: 'Letter Cake', precio: 30000, imagen: './img/lettercakeflores.jpg' }, //cambiar la ruta de la imagen manualmente (no abre menú desplegable)
    ...
    function redirigirFormspree() {
        ...
        form.action = 'https://formspree.io/f/xkgrzrqv'; // Reemplaza esta dirección con tu código de Formspree
        form.method = 'POST';
